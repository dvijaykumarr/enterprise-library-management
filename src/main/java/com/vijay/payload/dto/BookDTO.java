...
public class BookDTO {
    ...
    // all backend validations are included in DTO class
    // if validation criteria is not met then exception message will be thrown
    @NotBlank(message = "ISBN is mandatory")
    private String isbn;

    @NotBlank(message = "Title is mandatory")
    @Size(min = 1, max = 255, message = "Tile must be between 1 and 255 characters")
    ...
    @Size(max = 2000, message = "Description must not exceed more than 2000 characters")
